...
from .admission_dialogue import (
    ...
    contextual_admission_profile_from_tool_history,
...
def run_admission_pipeline(
    *,
    ...
    context_profile = (
        contextual_admission_profile(request_payload)
        or contextual_admission_profile_from_tool_history(history)
        or contextual_admission_profile_from_history(history)
    )
